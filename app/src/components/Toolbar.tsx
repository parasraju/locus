...
export function Toolbar({
  ...
  return (
    <div
      className={`relative z-30 flex justify-center border-b border-locus-border/50 transition-all duration-200 ${
        visible
          ? "translate-y-0 opacity-100"
          : "pointer-events-none -translate-y-2 opacity-0 h-0 overflow-hidden"
      }`}
    >
      <div className="flex items-center gap-0.5 rounded-locus-lg border border-locus-border bg-locus-surface/90 px-1.5 py-1 shadow-locus-card backdrop-blur-md my-1">
